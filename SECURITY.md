...
- Description, impact, and affected components (CLI flags, file I/O, dependency on **`godan`** (`github.com/marcuwynu23/godan/lib`), etc.)
...
This policy covers the **dan-cli** repository (command-line tool, build scripts, and bundled examples). Parser/encoder logic lives in the **godan** module ([**godan** repository](https://github.com/marcuwynu23/godan)); if the issue is purely in the library, maintainers may move the advisory to the correct repo.
